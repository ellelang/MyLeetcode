...
select concat(author_lname, 'is', char_length(author_lname), 'char long') from books;
select upper('hello world');

select concat('favorite book is' , ' ',  upper (title)) as fav from books;

select distinct released_year from books;
select distinct author_lname, author_fname from books;
select title from books order by title DESC LIMIT 0,5;
SELECT author_fname
FROM BOOKS
